...
//                    myAdapter2.notifyDataSetChanged();
        ...
        new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(ItemTouchHelper.UP | ItemTouchHelper.DOWN, ItemTouchHelper.END) {
            @Override
            ...
            public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                Snackbar.make(getActivity().findViewById(R.id.WordsFragmentView), "删除了一个词汇", Snackbar.LENGTH_SHORT)
